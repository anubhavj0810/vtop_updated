...
// //const user = os.userInfo()
// //console.log(user)
// const mem = os.totalmem()/(Math.pow(10, 9))
// const childProcess = require('child_process')
// //let user1 = []
// const plugin = {
//   /**
...
//     // then please feel free to send me a pull request. This is version 0.1
//     // and needs some love.
//     childProcess.exec('ps -ewwwo %cpu,%mem,pid,user,comm', (error, stdout, stderr) => {
//       if (error) {
//         console.error(error)
//       }
//       const lines = stdout.split('\n')
...
//         // const pid=parseFloat(stats[stat].pid).toFixed(1)
//         statsArray.push({
//           ' pid  Command': stats[stat].pid.concat(" ").concat(stats[stat].comm),
//           'Count': stats[stat].count,
//           'pid': stats[stat].pid,
//           'CPU%': cpuRounded,
//           'Memory': memRounded*plugin.mem1,
